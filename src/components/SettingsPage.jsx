...
export default function SettingsPage() {
  ...
  const backend = "https://smart-talk-zlxe.onrender.com"; // Backend API
  ...
  useEffect(() => {
    const unsub = auth.onAuthStateChanged(async (u) => {
      ...
      try {
        ...
        console.error(err);
        alert("Failed to load wallet/profile. Check console.");
      }
    });
    return () => unsub();
  }, []);
  ...
  return (
    ...
    >
      ...
      {/* ================= Other Sections (Preferences, Theme, Notifications, About) ================= */}
      {/* ... same as before ... */}
      <Section title="About" isDark={isDark}>
        ...
        <p>
          Visit our website:{" "}
          <a href="https://www.loechat.com" target="_blank" rel="noopener noreferrer" style={{ color: isDark ? "#4FC3F7" : "#007bff" }}>
            www.loechat.com
          </a>
        </p>
      </Section>
