      ...
      <div style={{ marginLeft: "auto", position: "relative" }}>
        ...
        {headerMenuOpen && (
          <div style={{
            ...
            <button onClick={() => { setHeaderMenuOpen(false); navigate(`/voice-call/${chatInfo?.id}`); }} style={menuBtnStyle}>📞 Call</button>
            <button onClick={() => { setHeaderMenuOpen(false); navigate(`/video-call/${chatInfo?.id}`); }} style={menuBtnStyle}>🎥 Video Call</button>
          </div>
        )}
      </div>
    </header>
